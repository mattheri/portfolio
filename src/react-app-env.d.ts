...
declare module 'fullpage.js' {
    export default function(containerSelector: string | HTMLElement, options: options): void;

    export interface options {
        anchors?: string[];
        animateAnchor?: boolean;
        autoScrolling?: boolean;
        bigSectionsDestination?: "top" | "bottom" | null; //top, bottom, null
        continuousHorizontal?: boolean;
        continuousVertical?: boolean;
        controlArrowColor?: string;
        controlArrows?: boolean;
        css3?: boolean;
        dragAndMove?: boolean | "horizontal" | "fingersonly"; //true, false, 'horizontal', 'fingersonly'
        easing?: string;
        easingcss3?: string;
        fadingEffect?: boolean | "sections" | "slides"; //true, false, 'sections', 'slides'
        fitToSection?: boolean;
        fitToSectionDelay?: number;
        fixedElements?: string; // '#header, .footer'
        hybrid?: boolean;
        interlockedSlides?: boolean | number[]; // true, false, [1, 3, 5]
